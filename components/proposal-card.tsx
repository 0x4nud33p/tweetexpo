    ...
    >
      <div className="p-4">
        <div className="flex justify-between items-start mb-2">
          <span className={`text-xs font-medium px-2 py-1 rounded-full uppercase ${getStatusClass()}`}>
            {proposal.status}
          </span>
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center text-sm">
            ...
            <span className="font-medium">{Math.round(proposal.votes * 1.4).toLocaleString()}</span>
          </div>
